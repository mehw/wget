...
LinkHeaders = [
    ...
    "<http://{{SRV_HOST}}:{{SRV_PORT}}/test1.meta4>; rel=describedby; pri=2; type=\"application/metalink4+xml\"",
...
MetaFile1_down = WgetFile ("test1.meta4", MetaXml1)

MetaFile2 = WgetFile ("test2.meta4", MetaXml2)

WGET_OPTIONS = "--trust-server-names --metalink-over-http --metaurl=2"
